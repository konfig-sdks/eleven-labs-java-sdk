...
public class AddVoiceResponseModel {
  ...
  **/
   ...
   * @return the AddVoiceResponseModel instance itself
   */
  public AddVoiceResponseModel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.voiceId, addVoiceResponseModel.voiceId)&&
        Objects.equals(this.additionalProperties, addVoiceResponseModel.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(voiceId, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AddVoiceResponseModel
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AddVoiceResponseModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AddVoiceResponseModel>() {
           ...
           public AddVoiceResponseModel read(JsonReader in) throws IOException {
             ...
             AddVoiceResponseModel instance = thisAdapter.fromJsonTree(jsonObj);
