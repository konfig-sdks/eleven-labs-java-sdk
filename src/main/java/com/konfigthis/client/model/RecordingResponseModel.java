...
public class RecordingResponseModel {
  ...
  **/
   ...
   * @return the RecordingResponseModel instance itself
   */
  public RecordingResponseModel putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.recordingId, recordingResponseModel.recordingId) &&
        Objects.equals(this.mimeType, recordingResponseModel.mimeType) &&
        ...
        Objects.equals(this.additionalProperties, recordingResponseModel.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(recordingId, mimeType, sizeBytes, uploadDateUnix, transcription, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to RecordingResponseModel
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RecordingResponseModel.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RecordingResponseModel>() {
           ...
           public RecordingResponseModel read(JsonReader in) throws IOException {
             ...
             RecordingResponseModel instance = thisAdapter.fromJsonTree(jsonObj);
